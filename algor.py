...
def algorithmode():
    ...
    commands = ["turn:left", "turn:right", "hand:reach", "hands:latch", "hand:turn", "hand:withdraw", "leftfoot:stepforth", "leftfoot:stepback",
                "rightfoot:stepforth", "rightfoot:stepback", "feet:equalise", "knees:bend", "knees:straighten", "waist:bend", "waist:straighten"]
